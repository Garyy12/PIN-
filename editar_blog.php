...
<header class="headers">
    ...
    <div class="header-content">
      <p>Plataforma Indigena Nacional</p>
      </div>
      <div class="button-container">
        <a href="admin/index.php" class="button">Inicio Panel</a>
...
if (isset($_GET['id'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $updateQuery = "UPDATE noticias SET titulo = '$nuevoTitulo', categoria = '$nuevaCategoria', descripcion = '$nuevaDescripcion', imagen = '$nuevaImagen' WHERE id = $id";
    ...
    $selectQuery = "SELECT * FROM noticias WHERE id = $id";
    ...
    if ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<select name='nueva_categoria'>";
