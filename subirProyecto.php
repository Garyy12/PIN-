...
// Verificar si el formulario ha sido enviado
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $query = "INSERT INTO proyectos (titulo, contenido, estado, miniatura, banner ) VALUES ('$titulo', '$Contenido', '$estado',  '$rutamini', '$rutaban')";
...
<body>
    ...
    <main class="contenedor seccion contenido-centrado">
        ...
        <form class="contacto" action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST" enctype="multipart/form-data">
            ...
            window.location.assign("listado_proyectos.php");
            </script>';
            }
            ?>
