...
<table>
    ...
    $consulta_total = "SELECT COUNT(*) AS total FROM proyectos";
    ...
    $consulta_paginada = "SELECT * FROM proyectos LIMIT $inicio_resultados, $resultados_por_pagina";
    ...
    while ($row = mysqli_fetch_assoc($result_paginado)) {
        ...
        echo "<td><a href='editar-proyec.php?id=$id'><img src='img/editarr.png' alt='Editar' class='edit-icon'></td>";
        echo "<td><a href='eliminar_proyecto.php?id=$id'><img src='img/eliminar.png' width='50 alt='Editar' class='edit-icon'></a></td>";
        echo "<td></td>";
        echo "</tr>";
