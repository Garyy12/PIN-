...
<head>
    ...
    <link rel="stylesheet" href="C:\wamp64\www\estados\css\styles.css">
...
<br><br><br><br><br><br>
      ...
      <center><h2>Aguascalientes</h2></center>

    <section class="imagen-central">
        <div class="contenedor-imagen">
        <img src="images/0.jpg" alt="Imagen Central">
        </div>
    </section>
    ...
    <main class="seccion contenedor">
      ...
      $conexion=mysqli_connect('127.0.0.1','u889522149_indigenas','123Indigenas.','u889522149_indigenas');
            //$password=password_hash($_POST['password'],PASSWORD_DEFAULT);
             ...
             $sql = "SELECT  id,titulo, descripcion, categoria, imagen FROM noticias where categoria = 'Aguascalientes'";
