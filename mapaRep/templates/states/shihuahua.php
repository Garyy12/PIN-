...
<br><br><br><br><br><br>
      ...
      <center><h2>Chihuahua</h2></center>
    

    <section class="imagen-central">
        <div class="contenedor-imagen">
        <img src="images/5.jpg" alt="Imagen Central">
        </div>
    </section>
...
<section class="seccion contenedor extras">
    ...
    $conexion=mysqli_connect('127.0.0.1','u889522149_indigenas','123Indigenas.','u889522149_indigenas');
            //$password=password_hash($_POST['password'],PASSWORD_DEFAULT);
             ...
             $sql = "SELECT  id,titulo, descripcion, categoria, imagen FROM noticias where categoria = 'Chihuahua'";
