            ...
            <div class="input_group">
                <div class="input_box">
                    <h4>Detalles Tarjeta</h4>
                            ...
                            paypal.Buttons({
                              ...
                              createOrder: function(data, actions) {
                                return actions.order.create({
                                  purchase_units: [{"description":"Tarjeta 1 con los beneficios basicos dentro de la pagina","amount":{"currency_code":"USD","value":4.60}}]
                                });
                              },
                      ...
                      actions.redirect("panelUsuario.php");
