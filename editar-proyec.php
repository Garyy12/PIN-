...
<header class="headers">
    ...
    <div class="header-content">
      ...
      <a href="listado_proyectos.php" class="button">Lista de Proyectos</a>
    </div>
</header>
  ...
  <?php
    ...
    if (isset($_GET['id'])) {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $updateQuery = "UPDATE proyectos SET titulo = '$nuevoTitulo', contenido = '$nuevoContenido', estado = '$nuevoEstado' WHERE id = $id";
        ...
        $selectQuery = "SELECT * FROM proyectos WHERE id = $id";
...
<body>
    ...
    <main class="contenedor seccion contenido-centrado">
        ...
        <form class="contacto"  method="POST" enctype="multipart/form-data">
               ...
               <?php
                echo "<a href='editar_banner.php?id=$id'><img src='img/editarr.png' alt='Editar' class='edit-icon'></a>";
                ?>
               
               <label for="imagen" >Cambia tu miniatura </label>
               <?php
                echo "<a href='editar_mini.php?id=$id'><img src='img/editarr.png'' alt='Editar' class='edit-icon'></a>";
                ?>
            <br></br>
